...
Ако дефинираме следният индекс и с projection заявим само birthdate и email полетата, FETCH stage-а няма да е нужен,защото цялата инф ще бъде върната от индеска:
